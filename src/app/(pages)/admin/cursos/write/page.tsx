...
const courseSchema = z.object({
    ...
    interestLink: z.string().refine(val => val.trim() === "" || val.startsWith("/") || /^https?:\/\//i.test(val), {
        message: "Informe um link válido (http://..., https://... ou /rota)",
    }),
    area: z
        .string()
        .min(1, "A área é obrigatória")
        .refine(val => ["doctors", "patients-caregivers", "others", "mentorships"].includes(val), {
            ...
            try {
                ...
                if (courseSnap.exists()) {
                    ...
                    reset({
                        ...
                        interestLink: data.interestLink || "",
                    });
                }
            } catch (error) {
        ...
        <div className="flex flex-col w-full min-h-screen bg-white font-poppins">
            ...
            <main className="w-full flex flex-col items-center justify-center text-black">
                <Form {...form}>
                    ...
                    >
                        <h1 className="text-verde-petroleo font-bold text-center mb-5">Editor de cursos</h1>
                        ...
                        <div className="w-full h-full flex flex-col gap-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Link do botão &quot;Tenho interesse&quot;</FormLabel>
                                        <FormControl>
                                            <input
                                                type="text"
                                    ...
                                    <FormItem>
                                        <Select value={field.value} onValueChange={field.onChange}>
                                            ...
                                            <SelectContent className="bg-white text-verde-petroleo font-semibold">
                                                ...
                                                <SelectItem value="patients-caregivers" className="hover:bg-ciano">
                                                    Pacientes e Cuidadores
                                                </SelectItem>
                                                <SelectItem value="others" className="hover:bg-ciano">
                                                    Demais Profissionais
                                                </SelectItem>
                                                <SelectItem value="mentorships" className="hover:bg-ciano">
                                                    Mentorias
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
