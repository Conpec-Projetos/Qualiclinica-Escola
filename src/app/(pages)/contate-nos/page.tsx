...
export default function ContactUs() {
  return (
    <div>
      <Navbar />
      <main className="font-[family-name:var(--font-poppins)] flex flex-col items-center gap-[2.625rem] p-[2rem]">
        <div className="flex flex-row gap-x-[4.3125rem] items-start justify-center bg-(--verde-petroleo) w-[67.25rem] h-[47rem] p-[4.75rem]">
          <div className="w-[28.8375rem] h-[37.5rem] bg-(--menta-claro2) rounded-[0.3125rem]"></div>
