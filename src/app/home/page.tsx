...
function ButtonHomeModel({ text }: { text: string }) {
  if (text == "Conheça-nos") {
    ...
    return (
      <button className="h-[3.125rem] flex gap-[4px] items-center px-[1rem] bg-(--magenta) rounded-[5px]">
...
function HeroHome() {
  return (
    <section className="flex justify-center items-center font-[family-name:var(--font-poppins)] bg-[var(--rosa-claro)] h-[23.125rem] w-[67.25rem] m-auto gap-x-[4rem]">
...
function ProfissionaisHome() {
  return (
    <section className="flex flex-col flex-wrap w-1vw h-[29.375rem] p-[5rem] bg-(--rosa-claro) gap-x-[3.19rem]">
      ...
      <h1 className="w-[25rem]">conheça nossos profissionais</h1>
      <p className="w-[24rem]">Nossa clínica é formada por profissionais altamente capacitados, que se dedicam ao <b>cuidado</b> de cada paciente e à <b>formação de cada aluno</b>.</p>
